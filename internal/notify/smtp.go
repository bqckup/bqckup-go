...
<th style="padding:8px 24px;text-align:left;color:#586069;font-weight:600;border-top:1px solid #e1e4e8;">Site</th>
<th style="padding:8px 12px;text-align:center;color:#586069;font-weight:600;border-top:1px solid #e1e4e8;">Runs</th>
<th style="padding:8px 12px;text-align:center;color:#586069;font-weight:600;border-top:1px solid #e1e4e8;">OK</th>
<th style="padding:8px 12px;text-align:center;color:#586069;font-weight:600;border-top:1px solid #e1e4e8;">Failed</th>
<th style="padding:8px 24px;text-align:left;color:#586069;font-weight:600;border-top:1px solid #e1e4e8;">Last Status</th>
</tr>
`, src, reportColor(), html.EscapeString(subject), html.EscapeString(serverLine(payload.Hostname, payload.ServerIP)))

	for _, site := range r.Sites {
		fmt.Fprintf(&body,
			`<tr><td style="padding:8px 24px;border-top:1px solid #e1e4e8;">%s</td><td style="padding:8px 12px;text-align:center;border-top:1px solid #e1e4e8;">%d</td><td style="padding:8px 12px;text-align:center;border-top:1px solid #e1e4e8;">%d</td><td style="padding:8px 12px;text-align:center;border-top:1px solid #e1e4e8;">%d</td><td style="padding:8px 24px;border-top:1px solid #e1e4e8;">%s</td></tr>
`,
			html.EscapeString(site.SiteName), site.TotalRuns, site.Successful, site.Failed, html.EscapeString(site.LastStatus),
		)
	}
	if len(r.Sites) == 0 {
		body.WriteString(`<tr><td colspan="5" style="padding:16px 24px;border-top:1px solid #e1e4e8;color:#586069;">No backup runs recorded for this period.</td></tr>
`)
	}
	body.WriteString(`</table>
`)
